...
<div class="card shadow-sm">
    <div class="card-header text-white d-flex justify-content-between align-items-center" style="background-color: var(--primary-color);">
        <h2 class="mb-0">Create Quiz</h2>
        <a href="{{ route('content.quiz') }}" class="btn btn-light" style="color: var(--primary-color);">
            <i class="bi bi-card-list me-1"></i> View All Quizzes
        </a>
    </div>
    ...
    <div class="card-body">
        ...
        @if(isset($quiz))
            <div class="mt-4">
                <h3 class="mb-3">Generated Quiz</h3>
                <pre class="border rounded p-3 bg-light">{{ $quiz }}</pre>
                ...
                <div class="mt-2 d-flex gap-2">
                    ...
                    <button class="btn btn-outline-secondary" onclick="copyToClipboard(`{!! addslashes($quiz) !!}`)">
